...
- Name: Yanghua Liu
- Background: Regular user of Hermes Agent and Codex as coding agents
- What brought them to the hackathon: The WebMCP Challenge
...
- Experience level: Regular AI-assisted builder; conventional coding depth not yet specified
- Languages/frameworks known: No specific preference stated; comfortable delegating framework choices to Codex
- AI coding tools used before: Hermes Agent and Codex, used regularly
- Prior experience planning before coding: Uses coding agents regularly; following the structured guided path for this project
